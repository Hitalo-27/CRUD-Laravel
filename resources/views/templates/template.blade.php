...
<head>
    ...
    <link rel="stylesheet" href="{{url('assets/css/sidebar-themes.css')}}">
...
<body>
    <div class="page-wrapper default-theme sidebar-bg bg1 toggled">
        <nav id="sidebar" class="sidebar-wrapper">
            <div class="sidebar-content">
                ...
                <div class="sidebar-item sidebar-header d-flex flex-nowrap">
                    <div class="user-pic">
                        <img class="img-responsive img-rounded" src="{{url('assets/img/logo.png')}}" alt="User picture">
                    </div>
                </div>
                <!-- sidebar-search  -->
                    ...
                    <ul>
                        ...
                        <li class="sidebar-dropdown">
                            <a href="/generos">
                                ...
                                <span class="menu-text">Gêneros</span>
                            </a>
                        </li>
                        ...
                        <li class="sidebar-dropdown">
                            <a href="/insert">
                                ...
                                <span class="menu-text">Inserção</span>
                            </a>
                        </li>
                    </ul>
                </div>
        ...
        <div class="body">
            ...
            <footer>
                <p class="p"> Todos os direitos reservados. </p>
                <p> © 2021 </p>
            </footer>
        </div>
    </div>
